//
//  boxProductTableView.swift
//  vivr
//
//  Created by max blessen on 9/3/15.
//  Copyright (c) 2015 max blessen. All rights reserved.
//

import UIKit

class boxProductTableView: UIViewController {
    
    @IBOutlet var boxProductTable: UITableView!
